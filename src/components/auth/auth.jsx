...
export default function Login({ setToken , SetUser}) {
  ...
  const switchToRegister = () => {
      document.querySelector(".buttonToLogin").classList.remove("buttonToLoginSelected")
      document.querySelector(".buttonToLogin").classList.add("buttonToLoginNotSelected")
      document.querySelector(".buttonToRegister").classList.add("buttonToRegisterSelected")
      document.querySelector(".buttonToRegister").classList.remove("buttonToRegisterNotSelected")
      document.querySelector(".authBlock").classList.add("BlockHidden")
      document.querySelector(".registerBlock").classList.remove("BlockHidden")
  }

  const switchToLogin = () => {
      document.querySelector(".buttonToLogin").classList.remove("buttonToLoginNotSelected")
      document.querySelector(".buttonToLogin").classList.add("buttonToLoginSelected")
      document.querySelector(".buttonToRegister").classList.add("buttonToRegisterNotSelected")
      document.querySelector(".buttonToRegister").classList.remove("buttonToRegisterSelected")
      document.querySelector(".authBlock").classList.remove("BlockHidden")
      document.querySelector(".registerBlock").classList.add("BlockHidden")

  }


  const handleLogIn = () =>{
      getUserByLogin(username).then((json)=>{
    ...
    return <div className="loginBackground">
        <div className="authBlockMain">
            ...
            <input type="button" className="buttonToLogin buttonToLoginSelected" value="Log In" onClick={switchToLogin}/>
            <input type="button" className="buttonToRegister buttonToRegisterNotSelected " value="REGISTER" onClick={switchToRegister}/>

            <div className="authBlock">
                <p className="loginLabelAuth">Login:</p>
            ...
            <div className="registerBlock BlockHidden">
                <p className="loginLabelRegister">CREATE LOGIN:</p>
                <input className="loginInputRegister" type="text" placeholder="Login" maxLength="14" onChange={e => setUserName(e.target.value)}/>
                <p className="passwordLabelRegister">CREATE PASSWORD:</p>
